    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-body bg-light mt-5">
                <h1 class="text-center">Add New Question</h1><hr>
                <form action="<?php echo URLROOT; ?>/questions/add/<?php echo $data['topic_id']; ?>" method="post">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <select name="level" class="form-control <?php echo (!empty($data['level_err'])) ? 'is-invalid' : ''; ?>" id="level">
                                ...
                                <option value="mindblow">Mindblow</option>
                            </select>
