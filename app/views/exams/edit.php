...
<a href="<?php echo URLROOT; ?>/exams/display/<?php echo $data['id']; ?> " class="btn btn-light py-2">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-body bg-light mt-5">
                <h1 class="text-center">Edit Exam</h1><hr>
                <form action="<?php echo URLROOT; ?>/exams/edit/<?php echo $data['id']; ?>" method="post">
